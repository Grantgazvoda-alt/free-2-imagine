...
export const TEMPLATES: TemplateItem[] = [
  {
    ...
    subtitle: "Neon-lit futuristic streetscapes",
    category: "ugc",
    kind: "image",
  ...
  },
  {
    ...
    subtitle: "Epic character in a magical world",
    category: "ugc",
    kind: "image",
  ...
  },
  {
    ...
    subtitle: "Dreamlike impossible environments",
    category: "commercial",
    kind: "image",
  ...
  {
    id: "noir-film",
    title: "Noir Film Frame",
    subtitle: "High-contrast dramatic monochrome",
    category: "ugc",
    kind: "image",
  ...
  },
  {
    id: "vaporwave",
    title: "Vaporwave",
    subtitle: "Retro 80s synthwave aesthetic",
    category: "ugc",
    kind: "image",
  ...
  },
  {
    id: "product-hero",
    title: "Product Hero",
    subtitle: "Clean studio-grade product shot",
    category: "commercial",
    kind: "image",
