 ...
 * 2-column grid of `TemplateCard` examples. Each card's CTA reports the picked
 * preset via `onUse`, so a screen can seed its prompt box with that example's
 * settings (title/subtitle → prompt, category → format, …).
 *
 * The grid content and tabs are CONTENT you pass in; the layout is fixed here so
 * every "examples" section reads the same.
 */
